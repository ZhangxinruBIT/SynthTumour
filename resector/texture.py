...
def clean_outside_resectable(
    ...
    # edit by xinxinzhang start
    resectable_hemisphere_mask = sitk.Cast(resectable_hemisphere_mask, sitk.sitkScale)
    gray_matter_mask = sitk.Cast(gray_matter_mask, sitk.sitkScale)
    # edit by xinxinzhang end
